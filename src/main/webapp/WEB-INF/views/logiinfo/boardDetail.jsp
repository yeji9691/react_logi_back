...
<script>
	...
	function downloadFunc(fn,tfn){
		var path='/compinfo/board/download?method=downloadFile';
		location.href=path+'&fileName='+fn+'&tempFileName='+tfn;
	}
	
	function reply(replyObj){
		var path='/logiinfo/registForm/view';
	...
	function findDetailBoardList(){
		...
		$.ajax({
			...
			success : function(data){						
				...
				html += "<td>" + board.title +"&emsp;&nbsp;&nbsp;"+ "<span class='sStyle'>조회수:"+board.hit+"</span></td>";
